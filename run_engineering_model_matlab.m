...
% Now the fields calculation
 ...
 % End of fields calculation
        ...
        RZ=0;
        [CURT(N),DCURT(N)]=CURRENT(TE,HAM,CURT(N),DCURT(N)); %current at the top 
        [CURB(N),DCURB(N)]=CURRENT(TE,HAB,CURB(N),DCURB(N)); %current at base
...
%       INTEGER NW2,NW1
     ...
     %DIPULSE_calc(index_zero)=0; %Carlos added for solving a problem
...
%	============================= INDUCTION COMPONENT OF Ez ==========
function y=EINDP(x,C,V,VC,R,ZS,TT,HR,RR,RG,ALPHA_TOWER,NC,QEV)
