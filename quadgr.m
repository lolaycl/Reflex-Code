...
%
%   QUADGR(FUN,A,B,TOL,TRACE) with non-zero TRACE displays the convergens
%   of the quadrature and the two extrapolations.
%
...
%   2010-04-14  Adapted to DBLQUAD and TRIPLEQUAD
